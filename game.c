...
/*********************************************************
   Return TRUE if the game has been won on this sub-board by current player
*/
             ...
             )
{
  ...
  //Interesting note: current player calling make_move is used to mark moves
  board[move[m-1]][move[m]] = player;
  
  //Calls gamewon with the board state of only the board the player just made a move on!
  //Smart! :)
